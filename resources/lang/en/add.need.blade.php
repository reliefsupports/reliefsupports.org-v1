        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ url("/needs/add")}}">
                    ...
                    <div class="form-group">
                        <label for="telephone" class="col-lg-2 control-label">Contact Number</label>
                        <div class="col-lg-10">
                    ...
                    <div class="form-group">
                        <label for="city" class="col-lg-2 control-label">Nearest Divisional Secretariats Office</label>
                        <div class="col-lg-10">
                            <input type="text" class="form-control" id="city" name="city" value="{{ old('city') }}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="needs" class="col-lg-2 control-label">Your Requirements</label>
                        <div class="col-lg-10">
                            <textarea class="form-control" rows="4" id="needs" name="needs" required>{{ old('needs') }}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="heads" class="col-lg-2 control-label">Number of People</label>
                        <div class="col-lg-10">
